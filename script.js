document.addEventListener('DOMContentLoaded', function () {
  ...
  const ANIMATION_SELECTOR = '.fade-in, [data-animate]';
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מינוף טורס משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '5a5daed9-4527-4108-9920-71c21b585842',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '5a5daed9-4527-4108-9920-71c21b585842';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '5a5daed9-4527-4108-9920-71c21b585842';
